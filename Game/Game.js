...
function Game(){
    ...
    alert("a few quick rules: If health = 0, you die. If fatuige = 100, you die. Be sure to check your stats at all times!")
    ...
    while(!confirm("Are you sure your name is "+playername+", your memory is not the best right now...")){
        playername = prompt("so what is your name?")
    }
    ...
    function Maincell(){
        ...
        else if (mainCell == "e"|| mainCell == "move e"){
            Bed();
        }
        else if(mainCell == "w" && inventory.keycard < 1 || mainCell == "move w" && inventory.keycard <1){
            alert("there is a door here. The only way through is a keycard or someone letting you out...");
            Maincell();
        }
        else if(mainCell == "w" && inventory.keycard >= 1 || mainCell == "move w" && inventory.keycard >= 1){
            var keyDoor = confirm("you can use your keycard on the door, would you like to go through?");
                if (keyDoor){
                    Blackmarket();
                }
                else{
    ...
    function Discoloredpatch(){ 
        ...
        else if(discoloredPatch == "armor"){
            checkArmor();
            Discoloredpatch();
        }
        else if(discoloredPatch == "n" && inventory.chisel >= 1){
            GuardhouseCloset();
        }
        else{
            alert("you can't do that");
    ...
    var guardCloset = prompt("The patch swings open, it turns out this is an abandoned service hatch, which means this cell was probably repurposed. You close this hatch behind you. There are cleaning supplies in here, a broom, a janitors cart and some bleach.  There is a door leading to the another room, which is quiet. \n -n\n -s \n -take \n -look at ").toLowerCase();
    ...
    if(guardCloset == "look at janitors cart"){
        ...
        if(janitorsCart == "move rags" && inventory.keycard < 1){
            var moveRags = confirm("you move the rags, and find an keycard... it can be good.  Take it?")
        
             if (moveRags){
                alert("you take the keycard");
                inventory.keycard += 1
                GuardhouseCloset();
            }
            else{
        ...
        else if(guardCloset == "s"){
            Discoloredpatch();
        }
        else if(guardCloset == "n"){
            alert("Congragulations, you have made it this far in the game, since the developer is extremley short on time, this part of the game is locked. you are probably cursing this early acess, but there is more to the game. keep going, the developer believes in you and are aware 👍🏻");
            GuardhouseCloset();
        }
        else if(guardCloset == "stats"){
            checkStats();
            GuardhouseCloset();
        }
        else if(guardCloset == "armor"){
            checkArmor();
            GuardhouseCloset();
        }
        else{
    ...
    function Blackmarket(){
        var blackMarket = prompt("you find yourself in a black market, most of the people are speaking russian, but you hear some broken english.  You cant escape, the area is walled off. \n -w")
        if(blackMarket == "w"){
            alert("testing area...........................................................................................................................................................................................................................................................................................................................................................................................Thanks for playing to this point")
        }
    }
}  
